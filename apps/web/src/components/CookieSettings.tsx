...
export default function CookieSettings({
	...
	return (
		...
		>
			...
			<div className="relative w-full max-w-[440px] bg-background border border-border rounded-xl p-7 shadow-[0_24px_80px_rgba(0,0,0,0.25)]">
				<h2 className="font-serif font-bold text-[1.2rem] text-foreground mb-1">
					Cookie settings
				</h2>
				...
				<div className="flex flex-col gap-4 mb-7">
					...
					<div className="flex items-center justify-between gap-4 py-3 px-4 border border-border rounded-lg">
						<div>
							<span className="font-mono text-[11px] font-semibold text-foreground tracking-[0.02em] block mb-0.5">
								Essential cookies
							</span>
							<span className="font-serif text-[0.82rem] text-grey-2 leading-normal">
					...
					<div className="flex items-center justify-between gap-4 py-3 px-4 border border-border rounded-lg">
						...
						<button
							...
							className={`w-10 h-[22px] rounded-full relative shrink-0 cursor-pointer border-none transition-colors duration-200 ${analytics ? "bg-green-500" : "bg-border"}`}
				...
				<button
					type="button"
					onClick={save}
					className="w-full font-mono text-[12px] font-semibold text-background bg-foreground py-3 rounded-md border-none cursor-pointer transition-colors duration-150 hover:bg-[#333]"
				>
					Save preferences
				</button>
			</div>
